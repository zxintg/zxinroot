...
public class NiceDialog extends BaseNiceDialog {
    ...
    public void convertView(NiceDialogViewHolder holder, BaseNiceDialog dialog) {
        ...
        int padding = SystemInfoUtil.getInstance(getContext()).dip2px(15);
        int line = SystemInfoUtil.getInstance(getContext()).dip2px(150);
        for (int i=0;i<itemList.length;i++){
            ...
            textView.setTextColor(UiUtils.getInstance(getContext()).getColor(R.color.color_333333));
            ...
            if(i!=itemList.length-1){
                ...
                view.setBackgroundColor(UiUtils.getInstance(getContext()).getColor(R.color.line_color));
    ...
    public void setShowCancelBtn(boolean isShowShowCancelBtn){
        ...
        setWidth(SystemInfoUtil.getInstance(getContext()).getScreenWidth()*2/3);
    }
