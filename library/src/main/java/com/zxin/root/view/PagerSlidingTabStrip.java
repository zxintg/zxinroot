...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int ScreenWidth = SystemInfoUtil.getInstance(getContext()).getScreenWidth();
        ...
        underlineHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, underlineHeight, SystemInfoUtil.getInstance(getContext()).getDisplayMetrics());
    ...
    private void addIconTab(int position,String mesg, int resId) {
        ...
        int padd = SystemInfoUtil.getInstance(getContext()).dip2px(15);
        radioButtton.setPadding(padd, padd, padd, padd);
        radioButtton.setGravity(Gravity.CENTER);
        radioButtton.setButtonDrawable(UiUtils.getInstance(getContext()).getDrawable(resId));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (pstsShowType == 0) {
            ...
            int excursion = (currentTab.getWidth() - SystemInfoUtil.getInstance(getContext()).dip2px(22)) / 2;
            canvas.drawRect(lineLeft + excursion, height - indicatorHeight, lineRight - excursion, height, rectPaint);
            // draw divider 分割线
            dividerPaint.setColor(dividerColor);
            for (int i = 0; i < tabCount - 1; i++) {
