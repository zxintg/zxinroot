...
import com.zxin.root.view.refreshers.LoadMoreWithNomoreRefresher;
...
public class RefreshCommonView extends LinearLayout{
    ...
    public RefreshCommonView(Context context, AttributeSet attrs) {
        ...
        background_color = typedArray.getColor(R.styleable.RefreshCommonView_refresh_bgColor, UiUtils.getInstance(getContext()).getColor(R.color.background_color));
        content_bgColor = typedArray.getColor(R.styleable.RefreshCommonView_content_bgColor, UiUtils.getInstance(getContext()).getColor(R.color.background_color));
        ...
        lineColor = typedArray.getColor(R.styleable.RefreshCommonView_halving_line_color, UiUtils.getInstance(getContext()).getColor(R.color.line_color));
        ...
        int padding = SystemInfoUtil.getInstance(getContext()).dip2px(paddingSize);
    ...
    private void setParameter() {
        ...
        if (positiveEnable){
            ...
            refreshRelativeLayout.setProgressColor(UiUtils.getInstance(getContext()).getColor(R.color.color_ffae12));
        }
        //拖拽或是滑动到边缘自动加载
    ...
    public void setRecyclerViewAdapter(RecyclerView.Adapter adapter){
        if(orientation==0){
            ...
            if (isWaterfall){
                ...
                recyclerView.setLayoutManager(UiUtils.getInstance(getContext()).getGridLayoutManager(rowNum));
        }else{
            //水平布局
            recyclerView.setLayoutManager(UiUtils.getInstance(getContext()).getLayoutManager(UiUtils.LayoutManager.HORIZONTAL));
        }
