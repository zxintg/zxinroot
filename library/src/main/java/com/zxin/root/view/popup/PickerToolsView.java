package com.zxin.root.view.popup;
...
public class PickerToolsView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(UiUtils.getInstance(getContext()).getColor(R.color.color_333333));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(UiUtils.getInstance(getContext()).getColor(R.color.text2));
    }
