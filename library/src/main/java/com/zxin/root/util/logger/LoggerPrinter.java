...
class LoggerPrinter implements Printer {
  ...
  public void d(@Nullable Object object) {
    log(Logger.DEBUG, null, BaseStringUtils.toString(object));
  }
  ...
  public void json(@Nullable String json) {
    if (BaseStringUtils.isNull(json)) {
  ...
  public void log(int priority,
    ...
    if (throwable != null && message != null) {
      message += " : " + BaseStringUtils.getStackTraceString(throwable);
    }
    if (throwable != null && message == null) {
      message = BaseStringUtils.getStackTraceString(throwable);
    }
    if (BaseStringUtils.isNull(message)) {
